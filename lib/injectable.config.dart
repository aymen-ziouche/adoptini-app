...
import 'package:adoptini_app/auth/data/repositories/auth_repo.dart' as _i15;
import 'package:adoptini_app/auth/domain/repositories/base_auth_repo.dart'
    as _i14;
import 'package:adoptini_app/auth/domain/usecases/login_usecase.dart' as _i16;
import 'package:adoptini_app/auth/domain/usecases/logout_usecase.dart' as _i17;
...
import 'package:adoptini_app/core/addPet/data/datasources/remote_pet_db.dart'
    as _i4;
import 'package:adoptini_app/core/addPet/data/repositories/add_pet_repo.dart'
    as _i11;
...
import 'package:adoptini_app/core/addPet/domain/usecases/add_pet_usecase.dart'
    as _i13;
import 'package:adoptini_app/utils/register_module.dart' as _i20;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i10.BaseAddPetRepo>(() => _i11.AddPetRepo(
          gh<_i4.BaseRemotePetDB>(),
          gh<_i3.BaseLocationService>(),
        ));
    gh.lazySingleton<_i12.BaseLocalUserDB>(
        () => _i12.LocalUserDB(gh<_i9.Isar>()));
    gh.factory<_i13.AddPetUsecase>(
        () => _i13.AddPetUsecase(gh<_i10.BaseAddPetRepo>()));
    gh.lazySingleton<_i14.BaseAuthRepo>(() => _i15.AuthRepo(
          gh<_i7.BaseRemoteUserDB>(),
          gh<_i8.FirebaseAuth>(),
          gh<_i12.BaseLocalUserDB>(),
        ));
    gh.factory<_i16.LoginUsecase>(
        () => _i16.LoginUsecase(gh<_i14.BaseAuthRepo>()));
    gh.factory<_i17.LogoutUseCase>(
        () => _i17.LogoutUseCase(gh<_i14.BaseAuthRepo>()));
    gh.factory<_i18.RegisterUsecase>(() => _i18.RegisterUsecase(
          gh<_i14.BaseAuthRepo>(),
          gh<_i3.BaseLocationService>(),
        ));
    gh.factory<_i19.StartAppUsecase>(
        () => _i19.StartAppUsecase(gh<_i14.BaseAuthRepo>()));
    return this;
  }
}
